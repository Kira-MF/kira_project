...
STANDS = {
    ...
    "Star Platinum": {
        ...
        "obtainable": True,
        "image": "https://static.jojowiki.com/images/thumb/4/4a/latest/20210527032012/Star_Platinum_Anime.png/300px-Star_Platinum_Anime.png"
    },
    "The World": {
        "user": "DIO",
        "part": 3,
        ...
        "obtainable": True,
        "image": "https://static.jojowiki.com/images/thumb/6/6e/latest/20210527030205/The_World_Anime.png/300px-The_World_Anime.png"
    },
    "Magician's Red": {
        "user": "Muhammad Avdol",
        "part": 3,
    ...
    "Dark Blue Moon": {
        "user": "Captain Tennille",
        "part": 3,
        "tier": "D",
        "stats": {"destructive_power": "C", "speed": "C", "range": "C", "durability": "C", "precision": "C", "potential": "E"},
        "power": 18,
        "ability": "Управление водой и ракушками",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Yellow Temperance": {
        ...
        "part": 3,
        "tier": "C",
        "stats": {"destructive_power": "B", "speed": "C", "range": "D", "durability": "A", "precision": "D", "potential": "E"},
        "power": 20,
        "ability": "Неразрушимая желеобразная субстанция",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Emperor": {
        ...
        "power": 24,
        "ability": "Самонаводящийся пистолет",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Hanged Man": {
        ...
        "part": 3,
        "tier": "B",
        "stats": {"destructive_power": "B", "speed": "A", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 26,
        "ability": "Путешествие через отражения",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Wheel of Fortune": {
        ...
        "part": 3,
        "tier": "C",
        "stats": {"destructive_power": "B", "speed": "C", "range": "C", "durability": "A", "precision": "C", "potential": "E"},
        "power": 20,
        "ability": "Сверхмощный автомобиль",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Justice": {
        ...
        "part": 3,
        "tier": "C",
        "stats": {"destructive_power": "D", "speed": "D", "range": "A", "durability": "A", "precision": "B", "potential": "E"},
        "power": 22,
        "ability": "Управление трупами через туман",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Judgement": {
        ...
        "part": 3,
        "tier": "B",
        "stats": {"destructive_power": "B", "speed": "B", "range": "C", "durability": "B", "precision": "B", "potential": "E"},
        "power": 24,
        "ability": "Создание существ из земли по желаниям",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "High Priestess": {
        ...
        "part": 3,
        "tier": "B",
        "stats": {"destructive_power": "B", "speed": "C", "range": "A", "durability": "A", "precision": "C", "potential": "E"},
        "power": 24,
        "ability": "Превращение в любой неорганический предмет",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Geb": {
        ...
        "part": 3,
        "tier": "A",
        "stats": {"destructive_power": "B", "speed": "A", "range": "A", "durability": "C", "precision": "A", "potential": "E"},
        "power": 30,
        "ability": "Управление водой на дальних расстояниях",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Tohth": {
        ...
        "part": 3,
        "tier": "D",
        "stats": {"destructive_power": "E", "speed": "E", "range": "A", "durability": "A", "precision": "A", "potential": "E"},
        "power": 18,
        "ability": "Предсказание будущего через комикс",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Khnum": {
        ...
        "part": 3,
        "tier": "D",
        "stats": {"destructive_power": "E", "speed": "E", "range": "E", "durability": "E", "precision": "A", "potential": "E"},
        "power": 10,
        "ability": "Изменение внешности",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Atum": {
        ...
        "part": 3,
        "tier": "A",
        "stats": {"destructive_power": "C", "speed": "C", "range": "D", "durability": "A", "precision": "A", "potential": "B"},
        "power": 26,
        "ability": "Кража душ + чтение мыслей",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Osiris": {
        ...
        "part": 3,
        "tier": "B",
        "stats": {"destructive_power": "E", "speed": "E", "range": "D", "durability": "A", "precision": "A", "potential": "B"},
        "power": 22,
        "ability": "Кража душ через азартные игры",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Horus": {
        ...
        "part": 3,
        "tier": "A",
        "stats": {"destructive_power": "A", "speed": "A", "range": "C", "durability": "B", "precision": "B", "potential": "E"},
        "power": 34,
        "ability": "Создание льда и управление им",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Crazy Diamond": {
        ...
        "part": 4,
        "tier": "S",
        "stats": {"destructive_power": "A", "speed": "A", "range": "D", "durability": "A", "precision": "B", "potential": "A"},
        "power": 46,
        "ability": "Восстановление и ремонт любых объектов",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "The Hand": {
        ...
        "part": 4,
        "tier": "A",
        "stats": {"destructive_power": "A", "speed": "B", "range": "D", "durability": "B", "precision": "E", "potential": "C"},
        "power": 28,
        "ability": "Стирание пространства правой рукой",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Bad Company": {
        ...
        "part": 4,
        "tier": "B",
        "stats": {"destructive_power": "C", "speed": "C", "range": "B", "durability": "C", "precision": "B", "potential": "C"},
        "power": 22,
        "ability": "Армия миниатюрных солдат",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Surface": {
        ...
        "part": 4,
        "tier": "D",
        "stats": {"destructive_power": "C", "speed": "C", "range": "D", "durability": "C", "precision": "B", "potential": "E"},
        "power": 16,
        "ability": "Копирует внешность и движения хозяина",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Pearl Jam": {
        ...
        "part": 4,
        "tier": "D",
        "stats": {"destructive_power": "E", "speed": "E", "range": "D", "durability": "A", "precision": "A", "potential": "E"},
        "power": 14,
        "ability": "Лечение болезней через еду",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Atom Heart Father": {
        ...
        "part": 4,
        "tier": "D",
        "stats": {"destructive_power": "E", "speed": "E", "range": "A", "durability": "A", "precision": "B", "potential": "E"},
        "power": 14,
        "ability": "Ловушка внутри фотографий",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Enigma": {
        ...
        "part": 4,
        "tier": "C",
        "stats": {"destructive_power": "C", "speed": "C", "range": "C", "durability": "B", "precision": "B", "potential": "E"},
        "power": 20,
        "ability": "Запечатывает существа в бумагу",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Spice Girl": {
        ...
        "part": 5,
        "tier": "B",
        "stats": {"destructive_power": "B", "speed": "B", "range": "D", "durability": "E", "precision": "B", "potential": "A"},
        "power": 28,
        "ability": "Размягчение любых объектов",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Moody Blues": {
        ...
        "part": 5,
        "tier": "C",
        "stats": {"destructive_power": "C", "speed": "C", "range": "D", "durability": "C", "precision": "B", "potential": "C"},
        "power": 20,
        "ability": "Воспроизведение прошлых событий",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "The Grateful Dead": {
        ...
        "part": 5,
        "tier": "A",
        "stats": {"destructive_power": "B", "speed": "B", "range": "A", "durability": "B", "precision": "C", "potential": "E"},
        "power": 30,
        "ability": "Ускоренное старение живых существ",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Man in the Mirror": {
        ...
        "part": 5,
        "tier": "C",
        "stats": {"destructive_power": "C", "speed": "C", "range": "B", "durability": "B", "precision": "B", "potential": "E"},
        "power": 22,
        "ability": "Затягивает в зеркальный мир",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Metallica": {
        ...
        "part": 5,
        "tier": "S",
        "stats": {"destructive_power": "A", "speed": "A", "range": "C", "durability": "B", "precision": "A", "potential": "C"},
        "power": 38,
        "ability": "Управление железом в крови",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "King Crimson": {
        ...
        "stats": {"destructive_power": "A", "speed": "A", "range": "D", "durability": "A", "precision": "B", "potential": "A"},
        "power": 44,
        "ability": "Стирание времени + предвидение будущего",
        "ability2": None,
        "evolves_to": "King Crimson Requiem",
        "obtainable": True,
        "image": ""
    },
    "Epitaph": {
        ...
        "part": 5,
        "tier": "B",
        "stats": {"destructive_power": "E", "speed": "E", "range": "E", "durability": "E", "precision": "A", "potential": "A"},
        "power": 20,
        "ability": "Предвидение будущего на 10 секунд",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Stone Free": {
        ...
        "stats": {"destructive_power": "B", "speed": "B", "range": "C", "durability": "B", "precision": "B", "potential": "A"},
        "power": 32,
        "ability": "Превращение тела в нити",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Whitesnake": {
        ...
        "part": 6,
        "tier": "S",
        "stats": {"destructive_power": "B", "speed": "B", "range": "D", "durability": "B", "precision": "A", "potential": "A"},
        "power": 36,
        "ability": "Кража дисков памяти и стендов",
        "ability2": None,
        "evolves_to": "C-Moon",
        "obtainable": True,
        "image": ""
    ...
    "Weather Report": {
        ...
        "part": 6,
        "tier": "S",
        "stats": {"destructive_power": "A", "speed": "A", "range": "A", "durability": "B", "precision": "B", "potential": "A"},
        "power": 42,
        "ability": "Управление погодой и атмосферой",
        "ability2": None,
        "evolves_to": "Heavy Weather",
        "obtainable": True,
        "image": ""
    },
    "Heavy Weather": {
        ...
        "power": 55,
        "ability": "Радуга превращает всё в улиток",
        "ability2": "Управление атмосферой на континентальном уровне",
        "evolves_to": None,
        "obtainable": False,
        "image": ""
    },
    "Burning Down the House": {
        ...
        "part": 6,
        "tier": "D",
        "stats": {"destructive_power": "E", "speed": "E", "range": "C", "durability": "A", "precision": "E", "potential": "C"},
        "power": 14,
        "ability": "Комната-призрак с предметами из прошлого",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Jail House Lock": {
        ...
        "part": 6,
        "tier": "C",
        "stats": {"destructive_power": "D", "speed": "C", "range": "B", "durability": "C", "precision": "B", "potential": "E"},
        "power": 20,
        "ability": "Жертва помнит только 3 вещи одновременно",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Scary Monsters": {
        ...
        "part": 7,
        "tier": "S",
        "stats": {"destructive_power": "A", "speed": "A", "range": "B", "durability": "A", "precision": "B", "potential": "C"},
        "power": 38,
        "ability": "Превращение в динозавра и других существ",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "In a Silent Way": {
        ...
        "stats": {"destructive_power": "B", "speed": "B", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 22,
        "ability": "Стальные шары создают мёртвые зоны",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Ticket to Ride": {
        ...
        "part": 7,
        "tier": "C",
        "stats": {"destructive_power": "D", "speed": "D", "range": "A", "durability": "A", "precision": "A", "potential": "E"},
        "power": 20,
        "ability": "Лечение стоит жизни других",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Mandom": {
        ...
        "part": 7,
        "tier": "A",
        "stats": {"destructive_power": "C", "speed": "A", "range": "C", "durability": "B", "precision": "A", "potential": "E"},
        "power": 26,
        "ability": "Откат времени на 6 секунд",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Tubular Bells": {
        ...
        "part": 7,
        "tier": "D",
        "stats": {"destructive_power": "C", "speed": "C", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 16,
        "ability": "Создание бомб из металлических предметов",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Boku no Rhythm wo Kiitekure": {
        "user": "Pork Pie Hat Kid",
        "part": 7,
        "tier": "D",
        "stats": {"destructive_power": "C", "speed": "C", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 16,
        "ability": "Противник делает то что ты делаешь",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Wired": {
        ...
        "part": 7,
        "tier": "D",
        "stats": {"destructive_power": "C", "speed": "C", "range": "B", "durability": "C", "precision": "C", "potential": "E"},
        "power": 15,
        "ability": "Невидимые провода",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Vitamin C": {
        ...
        "part": 8,
        "tier": "A",
        "stats": {"destructive_power": "B", "speed": "C", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 22,
        "ability": "Размягчение тела при касании отпечатков",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Awaking III Leaves": {
        ...
        "stats": {"destructive_power": "C", "speed": "C", "range": "C", "durability": "C", "precision": "B", "potential": "E"},
        "power": 18,
        "ability": "Рыболовный крючок через боль",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "I Am a Rock": {
        "user": "Yotsuyu Yagiyama",
        "part": 8,
        "tier": "B",
        "stats": {"destructive_power": "B", "speed": "B", "range": "C", "durability": "B", "precision": "B", "potential": "E"},
        "power": 26,
        "ability": "Притяжение объектов к цели",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    "Fun Fun Fun": {
        ...
        "part": 8,
        "tier": "B",
        "stats": {"destructive_power": "C", "speed": "B", "range": "A", "durability": "C", "precision": "A", "potential": "E"},
        "power": 24,
        "ability": "Дистанционный контроль через раны на конечностях",
        "ability2": None,
        "evolves_to": None,
        "obtainable": True,
        "image": ""
    ...
    # ???????????????????????????????????????????????
    # EVOLUTION-ONLY STANDS (obtainable: False)
    # ???????????????????????????????????????????????
...
EVOLUTION_CHAINS = {
    ...
    "The World": "The World Over Heaven",
    ...
    "D4C": "D4C Love Train",
    "Tusk Act 1": "Tusk Act 2",
    "Tusk Act 2": "Tusk Act 3",
    "Tusk Act 3": "Tusk Act 4",
    "Soft & Wet": "Soft & Wet Go Beyond",
    "Whitesnake": "C-Moon",
    "C-Moon": "Made in Heaven",
    "Echoes Act 1": "Echoes Act 2",
    "Echoes Act 2": "Echoes Act 3",
    "Weather Report": "Heavy Weather",
}

# ??? HELPER FUNCTIONS ?????????????????????????????????????????????

STAT_VALUES = {"A": 5, "B": 4, "C": 3, "D": 2, "E": 1}

def get_obtainable_stands():
    """Get all stands that can be obtained from arrows."""
    return {name: data for name, data in STANDS.items() if data.get("obtainable", True)}

def get_stand_by_tier(tier: str) -> list:
    """Get obtainable stands of a specific tier."""
    return [name for name, data in STANDS.items()
            if data.get("tier") == tier and data.get("obtainable", True)]

def get_stands_by_part(part: int) -> list:
    return [name for name, data in STANDS.items() if data["part"] == part]

def get_random_stand(tier: str = None):
    import random
    if tier:
        pool = get_stand_by_tier(tier)
    else:
        pool = [n for n, d in STANDS.items() if d.get("obtainable", True)]
    return random.choice(pool) if pool else None

def get_weighted_random_stand():
    import random
    pool = []
    for name, data in STANDS.items():
        if not data.get("obtainable", True):
            continue
        weight = int(TIER_WEIGHTS.get(data.get("tier", "C"), 10))
        pool.extend([name] * weight)
    return random.choice(pool)

def calculate_power(stats: dict) -> int:
    return sum(STAT_VALUES.get(v, 0) for v in stats.values()) * 2

def can_evolve(stand_name: str) -> bool:
    return stand_name in EVOLUTION_CHAINS

def get_evolution(stand_name: str):
    return EVOLUTION_CHAINS.get(stand_name)

if __name__ == "__main__":
    total = len(STANDS)
    obtainable = len(get_obtainable_stands())
    evo_only = total - obtainable
    print(f"Total stands: {total}")
    print(f"Obtainable: {obtainable}")
    print(f"Evolution-only: {evo_only}")
    print()
    for part in range(3, 9):
        stands = get_stands_by_part(part)
        if stands:
            print(f"Part {part}: {len(stands)} stands")
    print()
    for tier in ["D", "C", "B", "A", "S", "SS", "SSS"]:
        all_tier = [n for n, d in STANDS.items() if d.get("tier") == tier]
        obt = get_stand_by_tier(tier)
        print(f"Tier {tier}: {len(all_tier)} total ({len(obt)} obtainable)")
    print()
    print("Evolution chains:")
    for base, evo in EVOLUTION_CHAINS.items():
        print(f"  {base} ? {evo}")
